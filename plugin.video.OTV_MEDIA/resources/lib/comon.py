# -*- coding: utf-8 -*-
#import urllib.request, urllib.parse, urllib.error, urllib.request, urllib.error, urllib.parse, os, io, xbmc, xbmcaddon, xbmcgui, json, re, base64, xbmcvfs
#source = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789:;[]{^},.<>`?=( )/\&%$�@"!�'*`+��_~*-\t\n\x0b\x0c\r'
                                                       
#  t101t102t103t104t105t106t107t110t111t112t113t114t115Nt117t120t121t122t123t124t125t126t127t130t131t132at142t143deft147t150it152t153lt155nt157t160t161rst164ut166t167t170t171t1720123456789t72t73t133t135t173t136t175t54.t74t76t140t77t75t50t40t51t57t134t46t45t44t247t100t42t41t260t47t52 t140t53t264 t337 t137t176 t52t55  t134 t164 t134n t134t1700t142t134t1700t143t134r/f/f/"
...
def find_lpanel(url):
        ...
        link =  str(url).replace('get.php','panel_api.php')
        return link
...
def decodeHtmlentities(string):
    ...
    def substitute_entity(match):
        ...
        ent = match.group(2)
        if match.group(1) == "#":
            return chr(int(ent)).encode('utf-8')
        else:
            cp = n2cp.get(ent)
...
def StartDowloader(url,name,mode,DFolder):
    ...
    if notifica == 1:
        ...
        if not int(size)==fullsize:
            ...
            xbmc.executebuiltin('XBMC.RunPlugin(plugin://plugin.video.OTV_MEDIA/?url=' + urllib.parse.quote_plus(urlp) + '&name=' + name + '&mode=59)')
        else:
            if os.path.isfile(loc1):
                os.remove(loc1)
