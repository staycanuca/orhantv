...
JS_URL_TEMPLATE = "https://www.gstatic.com/recaptcha/releases/{}/recaptcha__de.js"

STRINGS_VERSION = "0.1.0"
STRINGS_PATH = 'special://home/userdata/addon_data/plugin.video.OTV_MEDIA'
...
class ReCaptcha(object):
    ...
    def get_headers(self, headers):
        ...
        if "Accept-Language" not in headers:
            headers["Accept-Language"] = "de,de-DE;q=0.9,en,en-US;q=0.8;q=0.7"
        return headers                    
