...
class lntvChannels(object):
    def __init__(self, config, cert, cert_key, user="", device_id="", android_id=""):
        ...
        self.apk_build = "36"
        self.apk_version = "4.8.3 (47)"
        self.apk_name = "com.playnet.androidtv.ads"
    ...
    def get_stream_21(self, stream):
        stream_url = b64decode(stream.get("Bc3RyZWFtX3VybA==")[1:]).decode("utf-8")
    ...
    def get_stream_34(self, stream):
        ...
        stream_url = self.custom_base64(stream.get("Bc3RyZWFtX3VybA==")[1:])
        page_url = b64decode(stream_url[1:]).split("|")[0].decode("utf-8")
        headers = {
            "User-Agent": ua,
            "Referer": stream.get("referer"),
        }
    ...
    def get_stream_45(self, stream):
        ...
        _split_decode = b64decode(stream_url[1:]).split("|").decode("utf-8")
