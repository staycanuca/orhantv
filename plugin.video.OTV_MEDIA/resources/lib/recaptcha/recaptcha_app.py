...
from resources.lib.recaptcha import myJDownloader
from resources.lib.recaptcha import TwoCaptcha
from resources.lib.recaptcha import captcha9kw
...
class PopupRecapInfoWindow(xbmcgui.WindowDialog):
    def __init__(self):
        ...
        PLUGIN_ID = 'plugin.video.OTV_MEDIA'
