...
from resources.sites.youtubecom_tr import youtubeplayer 
...
def turkhaber():
    ...
    tarzlistesi.append(("CNN TÜRK", "https://www.youtube.com/watch?v=-gaWiqGYTss"))
    tarzlistesi.append(("Halk Tv", "http://www.dailymotion.com/embed/video/x6bokr3"))
    tarzlistesi.append(("Ulusal Kanal", "https://www.youtube.com/watch?v=k6SNRgHEBKg"))
    tarzlistesi.append(("TV360", "https://www.youtube.com/watch?v=uXwUsFRPoyI"))

    tarzlistesi.append(("NTV", "https://www.youtube.com/watch?v=oruk-T3_xSw"))
    tarzlistesi.append(("Habertürk", "https://www.youtube.com/watch?v=iYY4F4EbWLc"))
    tarzlistesi.append(("TGRT Haber", "https://www.youtube.com/watch?v=m9WRghy7fNc"))
    tarzlistesi.append(("TVNET", "https://www.youtube.com/watch?v=faCQAWEbTtw"))
    tarzlistesi.append(("Bengü Türk", "https://www.youtube.com/watch?v=fZ06dn_O5ao"))
    tarzlistesi.append(("Tele1 TV", "https://www.youtube.com/watch?v=DelU9u84_Dg"))
